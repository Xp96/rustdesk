...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("powered_by_me", "Feito por RustDesk"),
        ("outgoing_only_desk_tip", "Esta é uma edição personalizada. Você pode se conectar a outros dispositivos, mas eles não podem se conectar ao seu."),
        ("preset_password_warning", "Esta edição personalizada vem com uma senha predefinida. Qualquer pessoa que a conhecer poderá ter controle total do seu dispositivo. Se não for isso que você esperava, desinstale o software imediatamente."),
        ("Security Alert", "Alerta de Segurança"),
        ("My address book", "Minha agenda de endereços"),
        ("Personal", "Pessoal"),
        ("Owner", "Proprietário"),
        ...
        ("share_warning_tip", "Os campos mostrados acima são compartilhados e visíveis para outros."),
        ("Everyone", "Todos"),
        ("ab_web_console_tip", "Mais informações no console da web"),
        ("allow-only-conn-window-open-tip", "Permitir a conexão apenas se a janela RusDesk estiver aberta"),
        ("no_need_privacy_mode_no_physical_displays_tip", "Não há telas físicas, não é necessário usar o modo privado."),
        ("Follow remote cursor", "Seguir cursor remoto"),
        ("Follow remote window focus", "Seguir janela remota em foco"),
        ("default_proxy_tip", "O protocolo e porta padrão são Socks5 e 1080"),
        ("no_audio_input_device_tip", "Nenhum dispositivo de entrada de áudio encontrado."),
        ("Incoming", "Entrada"),
        ("Outgoing", "Saída"),
        ("Clear Wayland screen selection", "Limpar seleção de tela Wayland"),
        ("clear_Wayland_screen_selection_tip", "Após limpar a seleção da tela, você pode selecioná-la novamente para compartilhar."),
        ("confirm_clear_Wayland_screen_selection_tip", "Tem certeza que deseja limpar a seleção da tela Wayland?"),
        ("android_new_voice_call_tip", "Nova solicitação de chamada de voz recebida. Se você aceitar, o áudio mudará para comunicação por voz."),
        ("texture_render_tip", "Use a renderização de textura para tornar as imagens mais suaves."),
        ("Use texture rendering", "Usar renderização de textura"),
        ("Floating window", "Janela flutuante"),
        ("floating_window_tip", "Ajuda a manter o serviço RustDesk em segundo plano em execução."),
        ("Keep screen on", "Manter tela ligada"),
        ("Never", "Nunca"),
        ("During controlled", "Durante o controle remoto"),
        ...
        ("enable-bot-tip", "Se você habilitar esse recurso, poderá receber o código 2FA do seu bot. Ele também pode funcionar como uma notificação de conexão."),
        ("enable-bot-desc", "1. Abra um chat com o @BotFather.\n2. Envie o comando \"/newbot\". Você receberá um token após concluir esta etapa.\n3. Inicie um chat com o seu bot recém-criado. Envie uma mensagem começando com uma barra (\"/\") como \"/ola\" para ativá-lo."),
        ("cancel-2fa-confirm-tip", "Tem certeza que deseja cancelar a 2FA?"),
        ("cancel-bot-confirm-tip", "Tem certeza que deseja cancelar o bot do Telegram?"),
    ].iter().cloned().collect();
}
